...
AS $$
DECLARE
  project_url TEXT := 'https://qjvrsrpowmryfrmrzunz.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFqdnJzcnBvd21yeWZybXJ6dW56Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyOTEzODU3NiwiZXhwIjoyMDQ0NzE0NTc2fQ.OQh-CqgQSZdHymvk0kxP_jOaBa957FPjO86dCd72sv0'; -- full access needed for http request to storage
